...
class _LoginPageState extends State<LoginPage> {
  SharedPreferences perf = SharedPreferences.getInstance() as SharedPreferences;
  ...
  Future<void> _login() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (response.statusCode == 200) {
        ...
        SharedPreferences refer1 = await perf;
        await refer1.setString('UseName', jsonStr['user']['name']);
        await refer1.setInt('userID', jsonStr['user']['id']);
        await refer1.setString('token', jsonStr['user']['token']);
